...
# DATABASE_URL is read directly from app config (not via
# config.set_main_option/ConfigParser) because a password containing '%'
# (common in URL-encoded special characters) trips ConfigParser's
